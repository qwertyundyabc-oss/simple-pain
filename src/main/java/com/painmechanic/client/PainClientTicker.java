...
public final class PainClientTicker {
	...
	public static void tick(MinecraftClient client) {
		...
		PainSystem.applyModifier(player, EntityAttributes.MOVEMENT_SPEED, SPEED_MODIFIER, reduction);
		PainSystem.applyModifier(player, EntityAttributes.ATTACK_DAMAGE, DAMAGE_MODIFIER, reduction);
		PainSystem.applyModifier(player, EntityAttributes.ATTACK_SPEED, ATTACK_SPEED_MODIFIER, reduction);
		float adrenalineBonus = adrenaline ? 0.25f : 0f;
		PainSystem.applyBonusModifier(player, EntityAttributes.MOVEMENT_SPEED, ADRENALINE_SPEED_MODIFIER, adrenalineBonus);
		PainSystem.applyBonusModifier(player, EntityAttributes.ATTACK_DAMAGE, ADRENALINE_DAMAGE_MODIFIER, adrenalineBonus);
		PainSystem.applyBonusModifier(player, EntityAttributes.ATTACK_SPEED, ADRENALINE_ATTACK_SPEED_MODIFIER, adrenalineBonus);
